...
class HC(ProcessModel):
    ...
    def calc(self):
        ...
        op_cost = op_cost_tot / (
            ...
            * self.InputData.Op_param["comp_cap"]["amount"]
            / 1000
        )

        self.LCI.add(name=("biosphere3", "Operational_Cost"), flow=op_cost)
    ...
    def report(self):
        ...
        for y in self.Index:
            ...
            report["Biosphere"][y][
                ("biosphere3", "2cb2333c-1599-46cf-8435-3dffce627524")
            ] = lci_report["Carbon monoxide, non-fossil"][
                y
            ...
            # N compounds
            report["Biosphere"][y][
                ("biosphere3", "e5ea66ee-28e2-4e9b-9a25-4414551d821c")
            ] = lci_report["Nitrogen"][
                y
            ]  # Nitrogen (air,)
            report["Biosphere"][y][
